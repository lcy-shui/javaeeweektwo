...
public class Goods {
    ...
    public Goods(int id, String name, String description, String price, int stock, int categoryLevel1Id, int categoryLevel2Id, int categoryLevel3Id, String fileName, int isDelete, String brand_id) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.price = price;
